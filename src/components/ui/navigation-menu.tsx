  ...
  ({ className, children, ...props }, ref) => {
    ...
    const handleKeyDown = (event: React.KeyboardEvent<HTMLButtonElement>) => {
      if (event.key === "Enter" || event.key === " ") {
        ...
        event.preventDefault();
        const firstItem = triggerRef.current?.nextElementSibling?.querySelector("a");
...
const NavigationMenuViewport = forwardRef<HTMLDivElement, NavigationMenuContentProps>(
  ({ className, ...props }, ref) => (
...
const NavigationMenuIndicator = forwardRef<HTMLDivElement, NavigationMenuContentProps>(
  ({ className, ...props }, ref) => (
    <NavigationMenuPrimitive.Indicator
      ref={ref}
      className={cn(
